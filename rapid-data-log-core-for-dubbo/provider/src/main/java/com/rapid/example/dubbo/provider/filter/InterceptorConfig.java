package com.rapid.example.dubbo.provider.filter;

import org.springframework.context.annotation.Configuration;
import org.springframework.web.servlet.config.annotation.InterceptorRegistry;
import org.springframework.web.servlet.config.annotation.WebMvcConfigurerAdapter;

import com.yueny.rapid.adapter.digest.web.interceptor.WebDigestLogHandlerInterceptor;
...
public class InterceptorConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(final InterceptorRegistry registry) {
		...
		final WebDigestLogHandlerInterceptor digestLogHandlerInterceptor = new WebDigestLogHandlerInterceptor(
		...
		// final DigestLogHandlerInterceptor digestLogHandlerInterceptor = new
